...
interface AdminEditUserModalProps {
  ...
  adminEditUserModal: string;
  setAdminEditUserModal: React.Dispatch<React.SetStateAction<ModalStates>>;
  teamId?: string;
}

export type MessageBoxState = "isOpen" | "isClosed";

export const AdminEditUserModal: React.FunctionComponent<AdminEditUserModalProps> = ({
  adminEditUserModal,
  setAdminEditUserModal,
  teamId,
  userInfo
}) => {
  // let [adminEditUserMutation, {data}] = useAdminEditUserInfoMutation()

  return (
    <>
      {adminEditUserModal === "isOpen" ? (
          ...
          >
            <Card p={0} pb={3} width={1}>
              ...
              >
                ...
                <Button
                  type="button"
                  onClick={() => setAdminEditUserModal("isClosed")}
                >
                  Close
                </Button>
              </Flex>
